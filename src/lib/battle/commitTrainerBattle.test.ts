...
import {
  ...
  type CommitTrainerBattleResult,
} from "./store";
...
function isCommitted(result: CommitTrainerBattleResult): boolean {
  return result.statusCode === 200;
}

function errorOf(result: CommitTrainerBattleResult): string | undefined {
